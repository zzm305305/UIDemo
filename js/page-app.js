...
function configurationElm(t, e) {
    ...
    $(".demo").on("click", ".configuration .dropdown-menu a",
    function(t) {
        t.preventDefault();
...
function(t, e) {
    ...
    function n(t, e, i) {
        if (Z.isFunction(e)) return Z.grep(t,
        function(t, n) {
            return !! e.call(t, n, t) !== i
        });
        if (e.nodeType) return Z.grep(t,
        function(t) {
            return t === e !== i
        });
        if ("string" == typeof e) {
    ...
    function l(t, e, i) {
        var n;
        if (void 0 === i && 1 === t.nodeType) if (n = "data-" + e.replace(_t, "-$1").toLowerCase(), i = t.getAttribute(n), "string" == typeof i) {
            try {
    ...
    function m(t, e) {
        for (var i = 0,
        n = t.length; n > i; i++) vt.set(t[i], "globalEval", !e || vt.get(e[i], "globalEval"))
    }
    function g(t, e) {
        var i, n, s, o, a, r, l, h;
        if (1 === e.nodeType) {
            ...
            bt.hasData(t) && (r = bt.access(t), l = Z.extend({},
            r), bt.set(e, l))
        }
    }
    function v(t, e) {
    ...
    function _(t) {
        var e = Q,
        i = Ft[t];
        return i || (i = y(t, e), "none" !== i && i || (Rt = (Rt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Rt[0].contentDocument, e.write(), e.close(), i = y(t, e), Rt.detach()), Ft[t] = i),
        i
    }
    function w(t, e, i) {
        ...
        i && ("" !== a || Z.contains(t.ownerDocument, t) || (a = Z.style(t, e)), Lt.test(a) && jt.test(e) && (n = r.width, s = r.minWidth, o = r.maxWidth, r.minWidth = r.maxWidth = r.width = a, a = i.width, r.width = n, r.minWidth = s, r.maxWidth = o)),
        void 0 !== a ? a + "": a
    }
    function x(t, e) {
        return {
    ...
    function C(t, e) {
        if (e in t) return e;
        for (var i = e[0].toUpperCase() + e.slice(1), n = e, s = Xt.length; s--;) if (e = Xt[s] + i, e in t) return e;
        return n
    }
    function k(t, e, i) {
        var n = Yt.exec(e);
    ...
    function D(t, e, i, n, s) {
        for (var o = i === (n ? "border": "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === i && (a += Z.css(t, i + xt[o], !0, s)),
        n ? ("content" === i && (a -= Z.css(t, "padding" + xt[o], !0, s)), "margin" !== i && (a -= Z.css(t, "border" + xt[o] + "Width", !0, s))) : (a += Z.css(t, "padding" + xt[o], !0, s), "padding" !== i && (a += Z.css(t, "border" + xt[o] + "Width", !0, s)));
        return a
    }
    function T(t, e, i) {
        var n = !0,
    ...
    function I(t, e) {
        ...
        n.style && (o[a] = vt.get(n, "olddisplay"), i = n.style.display, e ? (o[a] || "none" !== i || (n.style.display = ""), "" === n.style.display && Ct(n) && (o[a] = vt.access(n, "olddisplay", _(n.nodeName)))) : (s = Ct(n), "none" === i && s || vt.set(n, "olddisplay", s ? i: Z.css(n, "display"))));
        for (a = 0; r > a; a++) n = t[a],
    ...
    function A(t, e) {
        ...
        for (e = e ? 1 : 0; 4 > n; n += 2 - e) i = xt[n],
        s["margin" + i] = s["padding" + i] = t;
        return e && (s.opacity = s.width = t),
        s
    }
    function N(t, e, i) {
        for (var n, s = (ie[e] || []).concat(ie["*"]), o = 0, a = s.length; a > o; o++) if (n = s[o].call(i, e, t)) return n
    }
    function P(t, e, i) {
        ...
        1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [p.overflow, p.overflowX, p.overflowY], h = Z.css(t, "display"), c = "none" === h ? vt.get(t, "olddisplay") || _(t.nodeName) : h, "inline" === c && "none" === Z.css(t, "float") && (p.display = "inline-block")),
        i.overflow && (p.overflow = "hidden", u.always(function() {
            p.overflow = i.overflow[0],
            p.overflowX = i.overflow[1],
            p.overflowY = i.overflow[2]
        }));
        for (n in e) if (s = e[n], Jt.exec(s)) {
        ...
        if (Z.isEmptyObject(d))"inline" === ("none" === h ? _(t.nodeName) : h) && (p.display = h);
            ...
            for (n in d) a = N(f ? m[n] : 0, n, u),
            n in m || (m[n] = a.start, f && (a.end = a.start, a.start = "width" === n || "height" === n ? 1 : 0))
        }
    }
    function M(t, e) {
        var i, n, s, o, a;
        for (i in t) if (n = Z.camelCase(i), s = e[n], o = t[i], Z.isArray(o) && (s = o[1], o = t[i] = o[0]), i !== n && (t[n] = o, delete t[i]), a = Z.cssHooks[n], a && "expand" in a) {
            o = a.expand(o),
            delete t[n];
    ...
    function H(t, e, i) {
        ...
        c = h.props;
        for (M(c, h.opts.specialEasing); a > o; o++) if (n = ee[o].call(h, t, c, h.opts)) return n;
        return Z.map(c, N, h),
    ...
    function O(t) {
        return function(e, i) {
            ...
            if (Z.isFunction(i)) for (; n = o[s++];)"+" === n[0] ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
        }
    }
    function $(t, e, i, n) {
        function s(r) {
    ...
    Z.extend = Z.fn.extend = function() {
        ...
        r++), "object" == typeof a || Z.isFunction(a) || (a = {}), r === l && (a = this, r--); l > r; r++) if (null != (t = arguments[r])) for (e in t) i = a[e],
        n = t[e],
        a !== n && (h && n && (Z.isPlainObject(n) || (s = Z.isArray(n))) ? (s ? (s = !1, o = i && Z.isArray(i) ? i: []) : o = i && Z.isPlainObject(i) ? i: {},
    ...
    Z.extend({
        ...
        proxy: function(t, e) {
            ...
            Z.isFunction(t) ? (n = q.call(arguments, 2), s = function() {
    ...
    var st = function(t) {
        ...
        function v(t, e, i, s, o, a) {
            ...
            n(function(n, a, r, l) {
                ...
                y = i ? o || (n ? t: f || s) ? [] : a: b;
                if (i && i(b, y, r, l), s) for (h = g(y, p), s(h, [], r, l), c = h.length; c--;)(u = h[c]) && (y[p[c]] = !(b[p[c]] = u));
                if (n) {
                    if (o || t) {
                        if (o) {
        ...
        function b(t) {
            ...
            a, !0), c = [function(t, i, n) {
                ...
                return e = null,
                s
            }]; s > r; r++) if (i = x.relative[t[r].type]) c = [p(f(c), i)];
            else {
        ...
        N = e.setDocument = function(t) {
            ...
            $ = [], O = [], (w.qsa = vt.test(n.querySelectorAll)) && (s(function(t) {
                ...
                z.call(t, "[s!='']:x"),
                $.push("!=", at)
            }), O = O.length && new RegExp(O.join("|")), $ = $.length && new RegExp($.join("|")), e = vt.test(M.compareDocumentPosition), W = e || vt.test(M.contains) ?
            function(t, e) {
        ...
        e.attr = function(t, e) { (t.ownerDocument || t) !== P && N(t);
                    ...
                    function(t) {
                        ...
                        if (g) {
                            ...
                            if (f = [a ? g.firstChild: g.lastChild], a && b) {
                                for (c = g[R] || (g[R] = {}), h = c[t] || [], p = h[0] === j && h[1], d = h[0] === j && h[2], u = p && g.childNodes[p]; u = ++p && u && u[m] || (d = p = 0) || f.pop();) if (1 === u.nodeType && ++d && u === e) {
                                    c[t] = [j, p, d];
                                    break
                                }
                            } else if (b && (h = (e[R] || (e[R] = {}))[t]) && h[0] === j) d = h[1];
                            else for (; (u = ++p && u && u[m] || (d = p = 0) || f.pop()) && ((r ? u.nodeName.toLowerCase() !== v: 1 !== u.nodeType) || !++d || (b && ((u[R] || (u[R] = {}))[t] = [j, d]), u !== e)););
                            return d -= s,
                            d === n || d % n === 0 && d / n >= 0
                        }
                    }
        ...
        T = e.compile = function(t, e) {
            ...
            o = Y[t + " "];
            if (!o) {
                for (e || (e = D(t)), i = e.length; i--;) o = b(e[i]),
        ...
        I = e.select = function(t, e, i, n) {
            ...
            if (i = i || [], 1 === u.length) {
                ...
                for (s = ft.needsContext.test(t) ? 0 : o.length; s--&&(a = o[s], !x.relative[r = a.type]);) if ((l = x.find[r]) && (n = l(a.matches[0].replace(wt, xt), yt.test(o[0].type) && c(e.parentNode) || e))) {
    ...
    Z.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? Z.find.matchesSelector(n, t) ? [n] : [] : Z.find.matches(t, Z.grep(e,
        function(t) {
            return 1 === t.nodeType
        }))
    },
    ...
    ct = Z.fn.init = function(t, e) {
        ...
        if ("string" == typeof t) {
            ...
            if (i[1]) {
                if (e = e instanceof Z ? e[0] : e, Z.merge(this, Z.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e: Q, !0)), at.test(i[1]) && Z.isPlainObject(e)) for (i in e) Z.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this
            }
    ...
    Z.fn.extend({
        ...
        closest: function(t, e) {
            for (var i, n = 0,
            s = this.length,
            o = [], a = ot.test(t) || "string" != typeof t ? Z(t, e || this.context) : 0; s > n; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (a ? a.index(i) > -1 : 1 === i.nodeType && Z.find.matchesSelector(i, t))) {
                o.push(i);
                break
            }
    ...
    function(t, e) {
        Z.fn[t] = function(i, n) {
            ...
            this.length > 1 && (dt[t] || Z.unique(s), ut.test(t) && s.reverse()),
            this.pushStack(s)
        }
    });
    var pt = /\S+/g,
    ...
    Z.Callbacks = function(t) {
        t = "string" == typeof t ? ft[t] || o(t) : Z.extend({},
        t);
        var e, i, n, s, a, r, l = [],
        h = !t.once && [],
        c = function(o) {
            for (e = t.memory && o, i = !0, r = s || 0, s = 0, a = l.length, n = !0; l && a > r; r++) if (l[r].apply(o[0], o[1]) === !1 && t.stopOnFalse) {
                e = !1;
                break
            }
            n = !1,
        ...
        u = {
            ...
            remove: function() {
                ...
                function(t, e) {
                    for (var i; (i = Z.inArray(e, l, i)) > -1;) l.splice(i, 1),
                    n && (a >= i && a--, r >= i && r--)
                }),
                this
            },
    ...
    Z.extend({
        ...
        when: function(t) {
            ...
            if (a > 1) for (e = new Array(a), i = new Array(a), n = new Array(a); a > s; s++) o[s] && Z.isFunction(o[s].promise) ? o[s].promise().done(h(s, n, o)).fail(l.reject).progress(h(s, i, e)) : --r;
    ...
    Z.extend({
        ...
        ready: function(t) { (t === !0 ? --Z.readyWait: Z.isReady) || (Z.isReady = !0, t !== !0 && --Z.readyWait > 0 || (mt.resolveWith(Q, [Z]), Z.fn.triggerHandler && (Z(Q).triggerHandler("ready"), Z(Q).off("ready"))))
        }
    }),
    Z.ready.promise = function(e) {
        return mt || (mt = Z.Deferred(), "complete" === Q.readyState ? setTimeout(Z.ready) : (Q.addEventListener("DOMContentLoaded", a, !1), t.addEventListener("load", a, !1))),
        mt.promise(e)
    },
    Z.ready.promise();
    ...
    r.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 === e) this.cache[o] = {};
                ...
                Z.isArray(e) ? n = e.concat(e.map(Z.camelCase)) : (s = Z.camelCase(e), e in a ? n = [e, s] : (n = s, n = n in a ? [n] : n.match(pt) || [])),
                i = n.length;
                for (; i--;) delete a[n[i]]
            }
        },
        ...
        data: function(t, e) {
            ...
            function(e) {
                ...
                if (o && void 0 === e) {
                    ...
                    var i = bt.get(this, n);
                    bt.set(this, n, e),
                    -1 !== t.indexOf("-") && void 0 !== i && bt.set(this, t, e)
                })
            },
    ...
    Z.fn.extend({
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;) i = vt.get(o[a], t + "queueHooks"),
    ...
    Z.event = {
        ...
        add: function(t, e, i, n, s) {
            ...
            if (g) for (i.handler && (o = i, i = o.handler, s = o.selector), i.guid || (i.guid = Z.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(e) {
                return typeof Z !== Dt && Z.event.triggered !== e.type ? Z.event.dispatch.apply(t, arguments) : void 0
            }), e = (e || "").match(pt) || [""], h = e.length; h--;) r = Et.exec(e[h]) || [],
            p = m = r[1],
            f = (r[2] || "").split(".").sort(),
            p && (u = Z.event.special[p] || {},
            p = (s ? u.delegateType: u.bindType) || p, u = Z.event.special[p] || {},
            c = Z.extend({
                type: p,
                origType: m,
                data: n,
        ...
        remove: function(t, e, i, n, s) {
            ...
            if (g && (l = g.events)) {
                for (e = (e || "").match(pt) || [""], h = e.length; h--;) if (r = Et.exec(e[h]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
                    for (u = Z.event.special[p] || {},
                    p = (n ? u.delegateType: u.bindType) || p, d = l[p] || [], r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) c = d[o],
                    !s && m !== c.origType || i && i.guid !== c.guid || r && !r.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, u.remove && u.remove.call(t, c));
                    a && !d.length && (u.teardown && u.teardown.call(t, f, g.handle) !== !1 || Z.removeEvent(t, p, g.handle), delete l[p])
                } else for (p in l) Z.event.remove(t, p + e[h], i, n, !0);
        ...
        trigger: function(e, i, n, s) {
            ...
            if (a = r = n = n || Q, 3 !== n.nodeType && 8 !== n.nodeType && !St.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), h = p.indexOf(":") < 0 && "on" + p, e = e[Z.expando] ? e: new Z.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : Z.makeArray(i, [e]), u = Z.event.special[p] || {},
            s || !u.trigger || u.trigger.apply(n, i) !== !1)) {
                if (!s && !u.noBubble && !Z.isWindow(n)) {
                    for (l = u.delegateType || p, St.test(l + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a),
                    r = a;
                    r === (n.ownerDocument || Q) && d.push(r.defaultView || r.parentWindow || t)
                }
                for (o = 0; (a = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l: u.bindType || p,
                c = (vt.get(a, "events") || {})[e.type] && vt.get(a, "handle"),
                c && c.apply(a, i),
                c = h && a[h],
                c && c.apply && Z.acceptData(a) && (e.result = c.apply(a, i), e.result === !1 && e.preventDefault());
                return e.type = p,
                s || e.isDefaultPrevented() || u._default && u._default.apply(d.pop(), i) !== !1 || !Z.acceptData(n) || h && Z.isFunction(n[p]) && !Z.isWindow(n) && (r = n[h], r && (n[h] = null), Z.event.triggered = p, n[p](), Z.event.triggered = void 0, r && (n[h] = r)),
                e.result
            }
        },
        dispatch: function(t) {
        ...
        handlers: function(t, e) {
            ...
            r = e.delegateCount,
            l = t.target;
            if (r && l.nodeType && (!t.button || "click" !== t.type)) for (; l !== this; l = l.parentNode || this) if (l.disabled !== !0 || "click" !== t.type) {
                for (n = [], i = 0; r > i; i++) o = e[i],
                s = o.selector + " ",
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || Q, n = i.documentElement, s = i.body, t.pageX = e.clientX + (n && n.scrollLeft || s && s.scrollLeft || 0) - (n && n.clientLeft || s && s.clientLeft || 0), t.pageY = e.clientY + (n && n.scrollTop || s && s.scrollTop || 0) - (n && n.clientTop || s && s.clientTop || 0)),
        ...
        fix: function(t) {
            ...
            o = t,
            a = this.fixHooks[s];
            for (a || (this.fixHooks[s] = a = It.test(s) ? this.mouseHooks: Tt.test(s) ? this.keyHooks: {}), n = a.props ? this.props.concat(a.props) : this.props, t = new Z.Event(o), e = n.length; e--;) i = n[e],
            t[i] = o[i];
    ...
    function(t, e) {
        Z.event.special[t] = {
            ...
            handle: function(t) {
                ...
                s = t.relatedTarget,
                o = t.handleObj;
                return (!s || s !== n && !Z.contains(n, s)) && (t.type = o.origType, i = o.handler.apply(this, arguments), t.type = e),
                i
            }
        }
    }),
    ...
    Z.extend({
        clone: function(t, e, i) {
            ...
            if (! (G.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || Z.isXMLDoc(t))) for (a = v(r), o = v(t), n = 0, s = o.length; s > n; n++) b(o[n], a[n]);
            if (e) if (i) for (o = o || v(t), a = a || v(r), n = 0, s = o.length; s > n; n++) g(o[n], a[n]);
            else g(t, r);
            return a = v(r, "script"),
        ...
        buildFragment: function(t, e, i, n) {
            for (var s, o, a, r, l, h, c = e.createDocumentFragment(), u = [], d = 0, p = t.length; p > d; d++) if (s = t[d], s || 0 === s) if ("object" === Z.type(s)) Z.merge(u, s.nodeType ? [s] : s);
            else if (Pt.test(s)) {
            ...
            for (c.textContent = "", d = 0; s = u[d++];) if ((!n || -1 === Z.inArray(s, n)) && (l = Z.contains(s.ownerDocument, s), o = v(c.appendChild(s), "script"), l && m(o), i)) for (h = 0; s = o[h++];) Ot.test(s.type || "") && i.push(s);
            return c
        },
        cleanData: function(t) {
            for (var e, i, n, s, o = Z.event.special,
            a = 0; void 0 !== (i = t[a]); a++) {
    ...
    Z.fn.extend({
        ...
        remove: function(t, e) {
            ...
            i.parentNode && (e && Z.contains(i.ownerDocument, i) && m(v(i, "script")), i.parentNode.removeChild(i));
            return this
        },
        empty: function() {
        ...
        html: function(t) {
            ...
            function(t) {
                ...
                if ("string" == typeof t && !Mt.test(t) && !Wt[(Nt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n > i; i++) e = this[i] || {},
                        1 === e.nodeType && (Z.cleanData(v(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch(s) {}
                }
        ...
        domManip: function(t, e) {
            ...
            if (h && (i = Z.buildFragment(t, this[0].ownerDocument, !1, this), n = i.firstChild, 1 === i.childNodes.length && (i = n), n)) {
                for (s = Z.map(v(i, "script"), p), o = s.length; h > l; l++) a = i,
                l !== u && (a = Z.clone(a, !0, !0), o && Z.merge(s, v(a, "script"))),
                e.call(this[l], a, l);
                if (o) for (r = s[s.length - 1].ownerDocument, Z.map(s, f), l = 0; o > l; l++) a = s[l],
    ...
    function(t, e) {
        Z.fn[t] = function(t) {
            for (var i, n = [], s = Z(t), o = s.length - 1, a = 0; o >= a; a++) i = a === o ? this: this.clone(!0),
            Z(s[a])[e](i),
            Y.apply(n, i.get());
    ...
    Z.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                void 0 === i ? a && "get" in a && void 0 !== (s = a.get(t, !1, n)) ? s: l[e] : (o = typeof i, "string" === o && (s = Ut.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(Z.css(t, e)), o = "number"), void(null != i && i === i && ("number" !== o || Z.cssNumber[r] || (i += "px"), G.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), a && "set" in a && void 0 === (i = a.set(t, i, n)) || (l[e] = i))))
            }
        },
    ...
    function(t, e) {
        Z.cssHooks[e] = {
            get: function(t, i, n) {
                return i ? Bt.test(Z.css(t, "display")) && 0 === t.offsetWidth ? Z.swap(t, Kt,
                function() {
                    return T(t, e, n)
                }) : T(t, e, n) : void 0
            },
    ...
    Z.cssHooks.marginRight = x(G.reliableMarginRight,
    function(t, e) {
        return e ? Z.swap(t, {
    ...
    function(t, e) {
        Z.cssHooks[t + e] = {
            expand: function(i) {
                for (var n = 0,
                s = {},
                o = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) s[t + xt[n] + e] = o[n] || o[n - 2] || o[0];
                return s
            }
        },
    ...
    Z.speed = function(t, e, i) {
        var n = t && "object" == typeof t ? Z.extend({},
        t) : {
    ...
    Z.fn.extend({
        ...
        animate: function(t, e, i, n) {
            ...
            o = Z.speed(e, i, n),
            a = function() {
                var e = H(this, Z.extend({},
                t), o); (s || vt.get(this, "finish")) && e.stop(!0)
            };
            return a.finish = a,
        ...
        stop: function(t, e, i) {
            ...
            this.each(function() {
                ...
                else for (s in a) a[s] && a[s].stop && te.test(s) && n(a[s]);
                for (s = o.length; s--;) o[s].elem !== this || null != t && o[s].queue !== t || (o[s].anim.stop(i), e = !1, o.splice(s, 1)); (e || !i) && Z.dequeue(this, t)
            })
        },
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
    ...
    Z.fx.tick = function() {
        var t, e = 0,
        i = Z.timers;
        for (Gt = Z.now(); e < i.length; e++) t = i[e],
    ...
    Z.extend({
        ...
        removeAttr: function(t, e) {
            var i, n, s = 0,
            o = e && e.match(pt);
            if (o && 1 === t.nodeType) for (; i = o[s++];) n = Z.propFix[i] || i,
    ...
    function(t, e) {
        ...
        oe[e] = function(t, e, n) {
            var s, o;
            return n || (o = oe[e], oe[e] = s, s = null != i(t, e, n) ? e.toLowerCase() : null, oe[e] = o),
            s
        }
    });
    ...
    Z.fn.extend({
        addClass: function(t) {
            ...
            if (r) for (e = (t || "").match(pt) || []; h > l; l++) if (i = this[l], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(re, " ") : " ")) {
        ...
        toggleClass: function(t, e) {
            var i = typeof t;
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(Z.isFunction(t) ?
            function(i) {
                Z(this).toggleClass(t.call(this, i, this.className, e), e)
            }: function() {
                if ("string" === i) for (var e, n = 0,
                s = Z(this), o = t.match(pt) || []; e = o[n++];) s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
        ...
        hasClass: function(t) {
            for (var e = " " + t + " ",
            i = 0,
            n = this.length; n > i; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(re, " ").indexOf(e) >= 0) return ! 0;
            return ! 1
        }
    });
    var le = /\r/g;
    Z.fn.extend({
        val: function(t) {
            ...
            return arguments.length ? (n = Z.isFunction(t), this.each(function(i) {
                var s;
                1 === this.nodeType && (s = n ? t.call(this, i, Z(this).val()) : t, null == s ? s = "": "number" == typeof s ? s += "": Z.isArray(s) && (s = Z.map(s,
                function(t) {
                    return null == t ? "": t + ""
        ...
        valHooks: {
            ...
            select: {
                get: function(t) {
                    ...
                    a = o ? null: [], r = o ? s + 1 : n.length, l = 0 > s ? r: o ? s: 0; r > l; l++) if (i = n[l], !(!i.selected && l !== s || (G.optDisabled ? i.disabled: null !== i.getAttribute("disabled")) || i.parentNode.disabled && Z.nodeName(i.parentNode, "optgroup"))) {
                ...
                set: function(t, e) {
                    ...
                    o = Z.makeArray(e), a = s.length; a--;) n = s[a],
    ...
    Z.extend({
        ...
        ajax: function(t, e) {
            ...
            e = e || {};
            var n, s, o, a, r, l, h, c, u = Z.ajaxSetup({},
            e),
            d = u.context || u,
            ...
            s = u.url,
            u.hasContent || (u.data && (s = u.url += (ce.test(s) ? "&": "?") + u.data, delete u.data), u.cache === !1 && (u.url = de.test(s) ? s.replace(de, "$1_=" + he++) : s + (ce.test(s) ? "&": "?") + "_=" + he++)),
            u.ifModified && (Z.lastModified[s] && w.setRequestHeader("If-Modified-Since", Z.lastModified[s]), Z.etag[s] && w.setRequestHeader("If-None-Match", Z.etag[s])),
    ...
    function(t, e) {
        Z[e] = function(t, i, n, s) {
            return Z.isFunction(i) && (s = s || n, n = i, i = void 0),
            Z.ajax({
                url: t,
                type: e,
                dataType: s,
    ...
    Z.param = function(t, e) {
        ...
        if (void 0 === e && (e = Z.ajaxSettings && Z.ajaxSettings.traditional), Z.isArray(t) || t.jquery && !Z.isPlainObject(t)) Z.each(t,
        function() {
    ...
    Z.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var i = Z(this).val();
                return null == i ? null: Z.isArray(i) ? Z.map(i,
                function(t) {
                    return {
                        name: e.name,
                        value: t.replace(De, "\r\n")
    ...
    function(e, i, n) {
        ...
        n.always(function() {
            t[s] = o,
            e[s] && (e.jsonpCallback = i.jsonpCallback, Pe.push(s)),
    ...
    Z.fn.load = function(t, e, i) {
        ...
        var n, s, o, a = this,
        r = t.indexOf(" ");
        return r >= 0 && (n = Z.trim(t.slice(r)), t = t.slice(0, r)),
        Z.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (s = "POST"),
        a.length > 0 && Z.ajax({
            url: t,
            type: s,
            dataType: "html",
    ...
    Z.each(["top", "left"],
    function(t, e) {
        Z.cssHooks[e] = x(G.pixelPosition,
        function(t, i) {
...
function(t) {
    ...
    t.widget.extend = function(e) {
        for (var i, n, s = c.call(arguments, 1), o = 0, a = s.length; a > o; o++) for (i in s[o]) n = s[o][i],
    ...
    t.Widget.prototype = {
        ...
        option: function(e, i) {
            ...
            n = e.split("."), e = n.shift(), n.length) {
                ...
                this.options[e]), o = 0; n.length - 1 > o; o++) s[n[o]] = s[n[o]] || {},
                s = s[n[o]];
    ...
    t.widget("ui.accordion", {
        ...
        _animate: function(t, e, i) {
            ...
            e.length ? t.length ? (n = t.show().outerHeight(), e.animate(this.hideProps, {
                ...
                step: function(t, i) {
                    i.now = Math.round(t),
                    "height" !== i.prop ? r += i.now: "content" !== a.options.heightStyle && (i.now = Math.round(n - e.outerHeight() - r), r = 0)
                }
    ...
    t.widget("ui.menu", {
        ...
        _keydown: function(e) {
            ...
            default:
                ...
                n.length || (o = String.fromCharCode(e.keyCode), r = RegExp("^" + i(o), "i"), n = this.activeMenu.find(this.options.items).filter(function() {
                    return r.test(t(this).text())
                })),
    ...
    t.extend(s.prototype, {
        ...
        _dialogDatepicker: function(e, i, n, s, o) {
            ...
            this._pos || (l = document.documentElement.clientWidth, h = document.documentElement.clientHeight, c = document.documentElement.scrollLeft || document.body.scrollLeft, u = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [l / 2 - 100 + c, h / 2 - 150 + u]),
        ...
        parseDate: function(e, i, n) {
            ...
            for (s = 0; e.length > s; s++) if (y)"'" !== e.charAt(s) || _("'") ? C() : y = !1;
            ...
            if ( - 1 === m ? m = (new Date).getFullYear() : 100 > m && (m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (c >= m ? 0 : -100)), b > -1) for (g = 1, v = b; o = this._getDaysInMonth(m, g - 1), !(o >= v);) g++,
            v -= o;
        ...
        formatDate: function(t, e, i) {
            ...
            u = "",
            d = !1;
            if (e) for (n = 0; t.length > n; n++) if (d)"'" !== t.charAt(n) || l("'") ? u += t.charAt(n) : d = !1;
        ...
        _generateHTML: function(t) {
            ...
            Z = t.drawMonth - K,
            tt = t.drawYear;
            if (0 > Z && (Z += 12, tt--), J) for (e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - U[0] * U[1] + 1, J.getDate())), e = Q && Q > e ? Q: e; this._daylightSavingAdjust(new Date(tt, Z, 1)) > e;) Z--,
            0 > Z && (Z = 11, tt--);
                ...
                for (C = "", this.maxRows = 4, k = 0; U[1] > k; k++) {
                    if (D = this._daylightSavingAdjust(new Date(tt, Z, t.selectedDay)), T = " ui-corner-all", I = "", X) {
                        ...
                        case 0:
                            ...
                            break;
                        case U[1] - 1 : I += " ui-datepicker-group-last",
                    ...
                    for (I += S + "</tr></thead><tbody>", A = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, A)), N = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, P = Math.ceil((N + A) / 7), M = X && this.maxRows > P ? this.maxRows: P, this.maxRows = M, H = this._daylightSavingAdjust(new Date(tt, Z, 1 - N)), O = 0; M > O; O++) {
                        for (I += "<tr>", $ = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(H) + "</td>": "", w = 0; 7 > w; w++) z = g ? g.apply(t.input ? t.input[0] : null, [H]) : [!0, ""],
                        W = H.getMonth() !== Z,
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i, n) {
            ...
            for (d = n.snapElements.length - 1; d >= 0; d--) l = n.snapElements[d].left,
    ...
    function(t, e) {
        ...
        h.fn = t.extend(h.prototype, {
            parse: function(s, a, r, l) {
                ...
                "string" === d ? this.parse(n(s) || o._default) : "array" === d ? (f(c.rgba.props,
                function(t, e) {
                    p[e.idx] = i(s[e.idx], e)
                }), this) : "object" === d ? (s instanceof h ? f(c,
                function(t, e) {
            ...
            is: function(t) {
                ...
                function(t, o) {
                    var a, r = i[o.cache];
                    return r && (a = s[o.cache] || o.to && o.to(s._rgba) || [], f(o.props,
                    function(t, i) {
    ...
    t.effects.effect.explode = function(e, i) {
        ...
        y = [];
        for (o = 0; u > o; o++) for (l = g.top + o * b, c = o - (u - 1) / 2, a = 0; d > a; a++) r = g.left + a * v,
        h = a - (d - 1) / 2,
    ...
    t.effects.effect.size = function(e, i) {
        ...
        ("box" === m || "both" === m) && (o.from.y !== o.to.y && (b = b.concat(u), a.from = t.effects.setTransition(a, u, o.from.y, a.from), a.to = t.effects.setTransition(a, u, o.to.y, a.to)), o.from.x !== o.to.x && (b = b.concat(d), a.from = t.effects.setTransition(a, d, o.from.x, a.from), a.to = t.effects.setTransition(a, d, o.to.x, a.to))),
        ("content" === m || "both" === m) && o.from.y !== o.to.y && (b = b.concat(c).concat(h), a.from = t.effects.setTransition(a, c, o.from.y, a.from), a.to = t.effects.setTransition(a, c, o.to.y, a.to)),
        t.effects.save(a, b),
        a.show(),
        ...
        a.css(a.from),
        ("content" === m || "both" === m) && (u = u.concat(["marginTop", "marginBottom"]).concat(c), d = d.concat(["marginLeft", "marginRight"]), h = r.concat(u).concat(d), a.find("*[width]").each(function() {
            var i = t(this),
            n = {
                height: i.height(),
                width: i.width(),
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _mouseCapture: function(e) {
            ...
            n = this._normValueFromMouse(i), s = this._valueMax() - this._valueMin() + 1, this.handles.each(function(e) {
                var i = Math.abs(n - c.values(e)); (s > i || s === i && (e === c._lastChangedValue || c.values(e) === u.min)) && (s = i, o = t(this), a = e)
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _getItemsAsjQuery: function(e) {
            ...
            l = [],
            h = this._connectWith();
            if (h && e) for (n = h.length - 1; n >= 0; n--) for (o = t(h[n]), s = o.length - 1; s >= 0; s--) a = t.data(o[s], this.widgetFullName),
        ...
        _refreshItems: function(e) {
            ...
            d = this._connectWith();
            if (d && this.ready) for (i = d.length - 1; i >= 0; i--) for (s = t(d[i]), n = s.length - 1; n >= 0; n--) o = t.data(s[n], this.widgetFullName),
            o && o !== this && !o.options.disabled && (u.push([t.isFunction(o.options.items) ? o.options.items.call(o.element[0], e, {
                item: this.currentItem
            }) : t(o.options.items, o.element), o]), this.containers.push(o));
            for (i = u.length - 1; i >= 0; i--) for (a = u[i][1], r = u[i][0], n = 0, h = r.length; h > n; n++) l = t(r[n]),
    ...
    t.widget("ui.tooltip", {
        ...
        close: function(e) {
            ...
            s = this._find(n);
            this.closing || (clearInterval(this.delayedShow), n.data("ui-tooltip-title") && !n.attr("title") && n.attr("title", n.data("ui-tooltip-title")), this._removeDescribedBy(n), this.hiding = !0, s.stop(!0), this._hide(s, this.options.hide,
            function() {
...
function(t) {
    ...
    if (t.support.touch = "ontouchend" in document, t.support.touch) {
        ...
        n._touchStart = function(t) {
            var n = this; ! i && n._mouseCapture(t.originalEvent.changedTouches[0]) && (i = !0, n._touchMoved = !1, e(t, "mouseover"), e(t, "mousemove"), e(t, "mousedown"))
        },
...
function(t) {
    ...
    function i(n, s) {
        ...
        if (n.tag.isComment) s.allowComments && (o.push("<!--"), o.push(n.tag.rawAttributes), o.push(">"), s.format && e(n, s, o, r - 1));
            ...
            if (!n.isRoot && l && (o.push("<"), o.push(n.tag.name), t.each(n.attributes,
            function() {
                if ( - 1 == t.inArray(this.name, s.removeAttrs)) {
                    var e = RegExp(/^(['"]?)(.*?)['"]?$/).exec(this.value),
                    i = e[2],
                    a = e[1] || "'";
                    "class" == this.name && s.allowedClasses.length > 0 && (i = t.grep(i.split(" "),
                    function(e) {
                    ...
                    null != i && (i.length > 0 || t.inArray(this.name, n.tag.requiredAttributes) > -1) && (o.push(" "), o.push(this.name), o.push("="), o.push(a), o.push(i), o.push(a))
                }
            })), n.tag.isSelfClosing) l && o.push(" />"),
            a = !1;
                ...
                a = 0 == p.length;
                    ...
                    for (var p = [], m = 0; m < n.children.length; m++) {
                        ...
                        u(g) ? v.length > 0 && p.push(v) : (m != n.children.length - 1 || "br" != g.tag.name) && (s.format && e(g, s, p, r), p = p.concat(i(g, s)))
                    }
                    s.formatIndent--,
    ...
    function a(t) {
        return t ? (this.tag = t, this.isRoot = !1) : (this.tag = new l("root"), this.isRoot = !0),
        this.attributes = [],
        this.children = [],
            ...
            if ("--" == this.name ? (this.isComment = !0, this.isSelfClosing = !0, this.format = !0) : (this.isComment = !1, this.isSelfClosing = t.inArray(this.name, w) > -1, this.isNonClosing = t.inArray(this.name, x) > -1, this.isClosing = void 0 != i && i.length > 0, this.isInline = t.inArray(this.name, m) > -1, this.disallowNest = t.inArray(this.name, v) > -1, this.requiredParent = y[t.inArray(this.name, y) + 1], this.allowEmpty = s && t.inArray(this.name, s.allowEmpty) > -1, this.toProtect = t.inArray(this.name, _) > -1, this.format = t.inArray(this.name, g) > -1 || !this.isInline), this.rawAttributes = n, this.requiredAttributes = k[t.inArray(this.name, k) + 1], s) {
                if (s.tagAttributesCache || (s.tagAttributesCache = []), -1 == t.inArray(this.name, s.tagAttributesCache)) {
                    for (var e = C[t.inArray(this.name, C) + 1].slice(0), o = 0; o < s.allowedAttributes.length; o++) {
                        var a = s.allowedAttributes[o][0]; (1 == s.allowedAttributes[o].length || t.inArray(this.name, s.allowedAttributes[o][1]) > -1) && -1 == t.inArray(a, e) && e.push(a)
                    }
        ...
        for (var g; h = c.exec(e);) {
            ...
            if (g = c.lastIndex, v.isClosing) n(f, [v.name]) && (f.pop(), m = f[f.length - 1]);
                ...
                for (var w, x = new a(v); w = d.exec(v.rawAttributes);) {
                    if ("style" == w[1].toLowerCase() && o.replaceStyles) for (var C = !v.isInline,
                    k = 0; k < o.replaceStyles.length; k++) o.replaceStyles[k][0].test(w[2]) && (C || (v.render = !1, C = !0), m.children.push(x), f.push(x), m = x, v = new l(o.replaceStyles[k][1], "", "", o), x = new a(v));
                ...
                t.each(v.requiredAttributes,
                function() {
                    var t = this.toString();
                    x.hasAttribute(t) || x.attributes.push(new r(t, ""))
                });
                for (var D = 0; D < o.replace.length; D++) for (var T = 0; T < o.replace[D][0].length; T++) {
                ...
                var S = !0;
                if (m.isRoot || (m.tag.isInline && !v.isInline ? (S = s(f)) && (m = f[f.length - 1]) : m.tag.disallowNest && v.disallowNest && !v.requiredParent ? S = !1 : v.requiredParent && (S = n(f, v.requiredParent)) && (m = f[f.length - 1])), S) if (m.children.push(x), v.toProtect) for (var E; E = c.exec(e);) {
...
$(document).ready(function() {
    ...
    $("body").on("click", "#button-download-modal",
    function(t) {
        t.preventDefault(),
        downloadLayoutSrc()
    }),
    $("body").on("click", "#download",
    function() {
        return downloadLayout(),
        !1
    }),
    $("body").on("click", "#downloadhtml",
    function() {
        return downloadHtmlLayout(),
        !1
    }),
    $("#edit").click(function() {
